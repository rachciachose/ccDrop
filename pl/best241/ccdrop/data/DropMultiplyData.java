...
public class DropMultiplyData
{
    ...
    public DropMultiplyData(final long timeTo, final int multiply, final int distance, final String world, final int x, final int y, final int z) {
        this.timeTo = timeTo;
